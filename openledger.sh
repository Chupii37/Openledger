...
additional_dependencies=("xorg" "xvfb" "sudo" "lxde" "ffmpeg" "libasound2" "libxss1" "libappindicator3-1" "libnss3" "libgtk-3-0" "libx11-xcb1" "libxtst6" "libvpx-dev" "mesa-utils" "libjsoncpp-dev" "libssl-dev" "libcurl4-openssl-dev" "libva2")
